...
const contactToAdminBody = (name, email, subject, message) => {
  return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
        ...
        <table width="420px" style="background: #134c49; margin: 0 auto; border: 2px solid #efefef; border-top: 0; border-bottom: 0;" cellpadding="18">
            <tr>
                <td style="text-align: center;">
                    ...
                    <p>&nbsp;</p>
                    <h4 style="margin-top:10px; color:#fff">Feedback</h4>
                </td>
            </tr>
                        ...
                        <tr>
                            <td>
                                <table width="380px" style="background: #fff; margin: 0 auto; border: 2px solid #efefef; text-align: left;" cellpadding="18">
                                    <tr>
                                        <td>
                                            <p><strong className="red-text">Feedback</strong></p>
                                            <hr />
                                            <p>
                                                Name: ${name}
                                            </p>
...
const feedbackReplyToUser = (name) => {
  return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
        ...
        <table width="420px" style="background: #134c49; margin: 0 auto; border: 2px solid #efefef; border-top: 0; border-bottom: 0;" cellpadding="18">
            <tr>
                <td style="text-align: center;">
                    ...
                    <p>&nbsp;</p>
                    <h4 style="margin-top:10px; color:#fff">Thankyou for contacting us!</h4>
                </td>
            </tr>
